// ============================================================
// VRCX-Cloud Server — Shared TypeScript types
// ============================================================
...
export interface VRChatNotification {
    id: string;
    type: 'friendRequest' | 'invite' | 'requestInvite' | 'requestInviteResponse'
        | 'votetokick' | 'halp' | 'hidden' | string;
    senderUserId: string;
...
export interface PushCookieRequest {
    cookie: string; // Base64-encoded encrypted cookie from desktop
}
...
// --- WebSocket update type for push --
